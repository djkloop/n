                    ...
                    <div className="space-y-6">
                      ...
                      <div className="flex items-start gap-4 group">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="rounded-lg overflow-hidden mb-4" style={{ backgroundColor: 'var(--surface-code)', border: '1px solid var(--border)' }}>
...
{`> ${getTerminalCommand(activePlatform)}`}
                          ...
                          <div className="rounded-lg overflow-hidden" style={{ backgroundColor: 'var(--surface-code)', border: '1px solid var(--border)' }}>
                            <pre className="text-xs leading-relaxed p-4 overflow-x-auto font-mono" style={{ color: 'var(--foreground-muted)' }}>
  ...
  : "~/.config/opencode/opencode.json"}
                      ...
                      <div className="flex items-start gap-4 group">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="rounded-lg overflow-hidden" style={{ backgroundColor: 'var(--surface-code)', border: '1px solid var(--border)' }}>
                            <pre className="max-h-96 overflow-auto text-xs leading-relaxed p-4 font-mono" style={{ color: 'var(--foreground-muted)' }}>
{`{
  "provider": {
    "cybertruckai": {
      "options": {
